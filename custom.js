...
function createTextContent(){
    ...
    content.forEach(element => {
        document.getElementById("textContent").appendChild(createListItem(element,"span","say"));
        document.getElementById("textContent").appendChild(createListItem("","br",""));
    });
...
function createContact(){
    ...
    var nameFBUpper = "";
    nameFB.split(" ").forEach(element => {
        nameFBUpper+=capitalizeTxt(element)+" ";
    });
    document.getElementById("contact").innerHTML+='Contact: <a href="'+linkFB+'" target="_blank">'+nameFBUpper+'</a>';
}
createContact();
createTextContent();
createLove();
